	...
	: QWidget(parent)
{
    ...
    //设置按钮图标
    m_pCloseButton->setStyleSheet("QPushButton{border-image: url(:/icon/resource/icon/close_normal.png);}\
   ...
   m_pMinimizeButton->setStyleSheet("QPushButton{border-image: url(:/icon/resource/icon/minus_normal.png);}\
